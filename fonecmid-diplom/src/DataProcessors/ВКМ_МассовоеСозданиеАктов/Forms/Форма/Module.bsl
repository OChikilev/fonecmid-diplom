...
Функция ВыполнениеНаСервере(СоздатьРеализацию)	
	ДлительныеОперации.ВыполнитьФункцию(УникальныйИдентификатор, "Обработки.ВКМ_МассовоеСозданиеАктов.СозданиеСпискаНаСервере", Объект.Период, СоздатьРеализацию);	
КонецФункции
