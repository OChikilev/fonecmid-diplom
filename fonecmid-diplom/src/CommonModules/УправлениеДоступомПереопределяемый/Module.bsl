...
Процедура ПриЗаполненииВидовДоступа(ВидыДоступа) Экспорт
	...
	//++ Чикилев О.А.	
	ВидДоступа = ВидыДоступа.Добавить();
	ВидДоступа.Имя = "ФизическоеЛицо";
	ВидДоступа.Представление = НСтр("ru = 'Физические лица'");
	ВидДоступа.ТипЗначений   = Тип("СправочникСсылка.ВКМ_ФизическиеЛица");	
	//--	
КонецПроцедуры
...
Процедура ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления) Экспорт
	...
	ОписаниеПрофиля.Роли.Добавить("ЗапускТонкогоКлиента");
	ОписаниеПрофиля.Роли.Добавить("БазовыеПраваБСП");
	ОписаниеПрофиля.Роли.Добавить("ОбслуживаниеКлиента");
	ОписанияПрофилей.Добавить(ОписаниеПрофиля);
	
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя           = "Специалист";
	ОписаниеПрофиля.Идентификатор = "76fa0ecb-98aa-11df-b54f-e0cb4ed5f656";
	...
	ОписаниеПрофиля.Идентификатор = "77fa0ecb-98aa-11df-b54f-e0cb4ed5f657";
	ОписаниеПрофиля.Наименование  = НСтр("ru = 'Бухгалтер ИТ Фирмы'", ОбщегоНазначения.КодОсновногоЯзыка());
	ОписаниеПрофиля.Роли.Добавить("ЗапускВебКлиента");
	ОписаниеПрофиля.Роли.Добавить("ЗапускТонкогоКлиента");
	ОписаниеПрофиля.Роли.Добавить("БазовыеПраваБСП");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_Бухгалиер");
	ОписанияПрофилей.Добавить(ОписаниеПрофиля);
...
Процедура ПриЗаполненииИспользованияВидаДоступа(ВидДоступа, Использование) Экспорт
	...
	//++ Чикилев О.А. 2025.11.14
	Если ВидДоступа = "ФизическоеЛицо" Тогда
